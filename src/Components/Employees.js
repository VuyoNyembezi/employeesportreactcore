...
class Employees extends Component {
    ...
    refreshData() {
     ...
     {  
        ...
        axios.get(`http://localhost:45413/api/Employee/${this.state.employeeId}`,{headers}).then(response => {
    ...
    render() {
        ...
        <br/>
            <Navbar bg = "dark" variant = "dark" >
                    ...
                    <Nav.Link><NavLink className = "d-inline p-2 bg-dark text-white" to = "/Terminated" ><ImBin/> Terminated Employees </NavLink></Nav.Link>  
                    </Nav> 
